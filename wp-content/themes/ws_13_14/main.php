	...
	<div id="padding">
		<div id="isotope">
			...
			?>
				...
				<div class="absolvent relation-<?php echo str_replace(' ','-',strtolower(get_the_title()) ); ?>" studiengang="<?php	foreach(get_the_category() as $c){echo $c=$c->name;}; ?>" order="<?php echo $i; ?>" nachname="<?php echo types_render_field( 'lastname', array('raw'=>true) ) ?>">
				...
				<div class="absolvent-full relation-<?php echo str_replace(' ','-',strtolower(get_the_title()) ); ?>">
					...
					<div class="absolvent-info-outer row">
						<div class="absolvent-info-inner large-2 large-offset-1 columns">

<div id="werkschau-section" class="section fullscreen collapsed">
		...
		<li id="<?php echo strtolower(str_replace(' ', '-', get_the_title() ) );?>" class="werkschau-slide fullscreen" style="background-image: url(<?php echo wp_get_attachment_url( get_post_thumbnail_id($post->ID) ); ?>);">
